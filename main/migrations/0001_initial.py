    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.course')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_started', models.CharField(blank=True, max_length=200, null=True)),
                ('date_ended', models.CharField(blank=True, max_length=200, null=True)),
                ('time_duration', models.CharField(blank=True, max_length=200, null=True)),
                ('no_hours', models.CharField(blank=True, max_length=200, null=True)),
                ('seminar_type', models.CharField(blank=True, max_length=200, null=True)),
